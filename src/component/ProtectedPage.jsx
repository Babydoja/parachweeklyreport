...
const ProtectedPage = () => {
  ...
  // ✅ Hardcoded password instead of fetching from backend
  const correctPassword = "12345"; // <-- change this to your preferred password
    ...
    <div>
          ...
          <div className="bg-white p-10 rounded-lg shadow-lg w-[600px] h-[300px] max-w-full">
            ...
            {lockedOut && (
              <p className="text-red-600 text-center mt-4">
                Too many wrong attempts. Please refresh the page.
              </p>
            )}
          </div>
        </div>
      ...
      {/* {isAuthenticated && (
        <div className="p-10 text-center">
          ...
          <p className="text-lg mt-4">You have successfully entered the correct password!</p>
        </div>
      )} */}
    </div>
  );
